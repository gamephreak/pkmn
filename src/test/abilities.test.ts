...
describe('Abilities', () => {
  test('forGen', () => {
    ...
    expect(Object.keys(Abilities.forGen(3)).length).toBe(76);
    expect(Object.keys(Abilities.forGen(4)).length).toBe(76 + 47);
    expect(Object.keys(Abilities.forGen(5)).length).toBe(76 + 47 + 41);
    expect(Object.keys(Abilities.forGen(6)).length).toBe(76 + 47 + 41 + 27);
